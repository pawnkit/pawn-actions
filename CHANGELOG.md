...
- Default release-set smoke tests to signed toolchain set 36 from
  `pawnkit-spec v0.1.138`.

## 1.8.72 - 2026-08-03

- Default release-set smoke tests to `pawnkit-spec v0.1.137`.

## 1.8.71 - 2026-08-03

- Use corrected signed toolchain set 35 in release-set smoke tests.

## 1.8.70 - 2026-08-03

- Use signed toolchain set 34 in release-set smoke tests.
...
- Default release-set smoke tests to corrected signed set 26 with matching
  module-graph commit metadata.

## 1.8.61 - 2026-08-03

- Default release-set smoke tests to signed set 25 with pawnlint v1.8.47 and
  pawnlsp v0.34.30.

## 1.8.60 - 2026-08-03

- Default release-set smoke tests to corrected signed set 24.
...
- Update the documented PawnKit CLI download to v1.34.8.

## 1.8.42 - 2026-08-01

- Use the corrected signed toolchain with pawnlint 1.8.22 and pawnlsp 0.33.86 in smoke workflows.

## 1.8.41 - 2026-08-01

- Use the signed toolchain with pawnlint 1.8.22 and pawnlsp 0.33.86 in smoke
  workflows.

## 1.8.40 - 2026-08-01

- Use the signed toolchain with pawnlint 1.8.21 and pawnlsp 0.33.85 in smoke
  workflows.

## 1.8.39 - 2026-08-01

- Use the signed toolchain with pawnlint 1.8.20 and pawnlsp 0.33.84 in smoke
  workflows.

## 1.8.38 - 2026-08-01

- Use the signed toolchain with pawnlint 1.8.19 and pawnlsp 0.33.83 in smoke
  workflows.

## 1.8.37 - 2026-08-01

- Use the signed toolchain with pawnlint 1.8.18 and pawnlsp 0.33.82 in smoke
  workflows.
